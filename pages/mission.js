                ...
                <blockquote className="mt-8">
                  ...
                  <footer className="mt-4">
                    <p className="text-base font-semibold text-indigo-200">
                      Kimiya Monfared, CoFounder at RxGenius
                    </p>
                  </footer>
                </blockquote>
              </div>
        ...
        <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
          ...
          <div className="pt-12 sm:pt-16 lg:pt-20">
            ...
            <div className="mt-6 space-y-6 text-gray-500">
              <p className="text-lg">
                RxGenius is designed to help patients nationwide gain a better
                understanding of prescription drug prices by providing
                transparency to deceptive insurance practices because everyone
